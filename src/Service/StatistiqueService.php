...
class StatistiqueService
{
     ...
     */
    public function getStatistiquesJour(\DateTime $dateDebut, \DateTime $dateFin): array
    {
     ...
     */
    public function getProduitsPlusVendus(\DateTime $dateDebut, \DateTime $dateFin): array
    {
        $conn = $this->entityManager->getConnection();
    ...
    /**
     * Récupère la répartition des commandes par type de service
     */
    public function getCommandesParType(\DateTime $dateDebut, \DateTime $dateFin): array
    {
        $conn = $this->entityManager->getConnection();
        ...
        $data = [
            ...
            'A_EMPORTER' => ['total' => 0, 'montant' => 0, 'label' => 'À emporter'],
    ...
    /**
     * Récupère l'évolution des commandes sur les 7 derniers jours
     */
    public function getEvolutionSemaine(\DateTime $date): array
    {
        $conn = $this->entityManager->getConnection();
        $evolution = [];
        ...
        for ($i = 6; $i >= 0; $i--) {
            ...
            $jourEn = $jour->format('D');
            $jourFr = $jours[$jourEn] ?? $jourEn;
    ...
    /**
     * Récupère un résumé rapide pour le tableau de bord
     */
    public function getDashboardSummary(): array
    {
        ...
        return $this->getStatistiquesJour($today, $tomorrow);
    }
}
